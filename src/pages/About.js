...
function About() {
    ...
    <div className="container aboutus">
        <div className="row">
            ...
            <div className="col-md-6 col-12 my-auto">
                <h1 className="display-4 text-center my-5">{Translate("About Us ")}</h1>
                ...
                <div className="text-center col-md-6 col-12 mx-auto">
                    <Link to="/contact" className="btn btn-outline-dark btn-block btn-lg my-5">{Translate("Contact Us")}</Link>
                </div>
            </div>
        </div>
        <div className="about_company">
            <h1 className="display-4">{Translate("About Company")}</h1>
            <div className="pt-4">
        ...
        <TestimoniesList />
        <div className="team">
            <h1 className="display-4">{Translate("Our Team")}</h1>
        </div>
        <div className="row mb-5">
            {
                team.map(item => {
                    return <Team key={item.id} member={item}/>;
                })
            }
        </div>
        <div className="team">
            <h1 className="display-4">{Translate("Location")}</h1>
        </div>
        <Map />
    </div>
    )
