...
export default function RoomsFilter({rooms}) {
    ...
    return <option value={item} key={index}>{Translate(item)}</option>
    });
    ...
    return (
        <div className="container mt-5">
            <Title title={Translate("Search Rooms")} />
            <div className="row">
                <div className="col-md-6 col-12">
                    <div className="form-group">
                        <label htmlFor="type">{Translate("Room Type")}</label>
                        <select name="type" id="type" value={type} className="form-control" onChange={handleChange}>
                            {types}
                        </select>
                    </div>
                    <div className="form-group">
                        <label htmlFor="capacity">{Translate("Guests")}</label>
                        <select name="capacity" id="capacity" value={capacity} className="form-control" onChange={handleChange}>
                            {people}
                        </select>
                    </div>
                    <div className="form-group">
                        <label htmlFor="price">{Translate("Room Price")} ${price}</label>
                ...
                <div className="col-md-4 col-12 ml-auto">
                    <div className="custom-control custom-checkbox my-5">
                        ...
                        <label htmlFor="breakfast" className="custom-control-label">{Translate("Breakfast")}</label>
                    </div>
                    <div className="custom-control custom-checkbox">
                        <input type="checkbox" className="custom-control-input" name="pets" id="pets" checked={pets} onChange={handleChange} />
                        <label htmlFor="pets" className="custom-control-label">{Translate("Pets")}</label>
                    </div>
                    <div className="input-group my-5">
                        <label htmlFor="size" className="mr-3">{Translate("Room Size")} </label>
